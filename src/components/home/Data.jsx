...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title"> Moataz Mhamdi
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">
               Creative and results-driven Full Stack Developer, turning ideas into sleek, high-performance web applications with seamless user experiences and clean, efficient code.
            </p>
